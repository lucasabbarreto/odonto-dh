...
const controller = {
    ...
    exibirAgendamento: async (req, res) => {
        ...
        const data_agendamento = agendamentosServices.formatarData(agendamento.data_agendamento)
        
        res.render('alterarAgendamento', { dentistas, procedimentos, nome, agendamento, permissao, usuarioLogado, data_agendamento })
    },
    criarAgendamento: async (req, res) => {
        ...
        data_agendamento = `${data_agendamento}T12:00:00`
    ...
    alterarAgendamento: async (req, res) => {
        const { id } = req.params
        let { id_dentista, data_agendamento, id_procedimento } = req.body;
